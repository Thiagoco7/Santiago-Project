...
<ul class="nav nav-pills">
  <li role=""><a href="index.php">Inicio</a></li>
  <li role=""><a href="productos.php">Productos</a></li>
  <li role=""><a href="carrito.php">Carrito</a></li>
...
<div class="panel-body">
    ...
    <div class="footBtn">
        ...
        <a href="hola.php?action=placeOrder" class="btn btn-success orderBtn">Realizar pedido <i class="glyphicon glyphicon-menu-right"></i></a>
    </div>
        </div>
